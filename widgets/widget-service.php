...
// service item
class Mega_Addons_Widget_Service extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Service Item', 'megaaddons' );
   }
   ...
   protected function _register_controls() {
      $this->start_controls_section(
         'service_section',
         [
            'label' => esc_html__( 'Service Item', 'megaaddons' ),
      ...
      $this->add_control(
         'style',
         [
            'label' => __( 'Service Style', 'megaaddons' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'default' => 'center',
            'options' => [
               'center'  => __( 'Center Icon', 'megaaddons' ),
               'left' => __( 'Left Icon', 'megaaddons' ),
            ],
         ]
      );
...
Plugin::instance()->widgets_manager->register_widget_type( new Mega_Addons_Widget_Service );